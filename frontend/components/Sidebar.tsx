...
export default function Sidebar({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
    ...
    return (
        <>
            ...
            <aside
                className={`w-64 bg-white dark:bg-zinc-900 flex flex-col fixed h-full z-50 transition-transform duration-300 md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'
                    }`}
            ...
            >
                ...
                <div className="p-4 border-t border-slate-100 dark:border-zinc-800 space-y-2">
                    ...
                    <Link href="/dashboard/admin/support" className={navLinkClass('/dashboard/admin/support')}>
                    ...
                    <div className="pt-2 text-center">
                        <p className="text-[10px] text-slate-400 font-bold tracking-widest">SHUBH EHS v2.1</p>
                    </div>
                </div>
            </aside>
        </>
